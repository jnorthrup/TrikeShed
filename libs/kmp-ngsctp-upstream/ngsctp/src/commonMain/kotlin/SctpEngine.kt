...
class SctpEngine(
     ...
     */
    suspend fun listen(address: CharSequence, port: Int): Unit = coroutineScope {
...
sealed class Chunk {
    ...
    data class Abort(val reason: CharSequence? = null) : Chunk()
...
class TimeoutException(message: CharSequence) : Exception(message)
