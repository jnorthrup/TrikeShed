...
interface BlockStore {
    ...
    /** Create an ObjectStorageBlockStore for S3 */
    companion object {
        @JvmStatic
        fun objectStorageS3(bucket: String, region: String = "us-east-1"): BlockStore {
            return ObjectStorageBlockStoreFactory.createS3(bucket, region)
        }

        @JvmStatic
        fun objectStorageGcs(bucket: String): BlockStore {
            return ObjectStorageBlockStoreFactory.createGcs(bucket)
        }

        @JvmStatic
        fun objectStorageAlibaba(bucket: String, endpoint: String, accessKey: String, secretKey: String): BlockStore {
            return ObjectStorageBlockStoreFactory.createAlibaba(bucket, endpoint, accessKey, secretKey)
        }
