...
actual fun aes256GcmEncrypt(
    ...
    error("AES-256-GCM encrypt not implemented for JS")
}
...
actual fun aes256GcmDecrypt(
    ...
    error("AES-256-GCM decrypt not implemented for JS")
}
