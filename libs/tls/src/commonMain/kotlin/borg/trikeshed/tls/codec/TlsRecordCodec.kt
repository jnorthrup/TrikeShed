...
interface TlsRecordCodec : CoroutineContext.Element {
     ...
     */
    suspend fun encrypt(direction: RecordDirection, innerType: ContentType, plaintext: ByteArray): ByteArray
     ...
     */
    suspend fun decrypt(direction: RecordDirection, wire: ByteArray): ByteArray?
