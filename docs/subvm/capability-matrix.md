...
| `js.leaf-delegation` | OK | 18 | phase=DELEGATED served={GUEST=12, SHADOW=2, MEMO=9} fires=1 |
| `js.process-wall` | OK | 599 | child pid alive=true; fib(10)=Num(v=55); host.call across wall=Num(v=8) |
| `python.eval` | OK | 66 | fib(15)=Num(v=610) |
| `python.host-delegate` | OK | 52 | host.call('double',21)=Num(v=42) |
...
| `python.root-observation` | OK | 45 | 177 fib frames via binding pointcuts, 177 self-contained |
| `python.leaf-delegation` | OK | 110 | phase=DELEGATED served={GUEST=12, SHADOW=2, MEMO=9} fires=1 |
| `python.process-wall` | OK | 1895 | child pid alive=true; fib(10)=Num(v=55); host.call across wall=Num(v=8) |
