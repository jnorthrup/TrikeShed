...
TEST_SOURCES=(
  src/commonTest/kotlin/borg/trikeshed/userspace/EmulatedRingTest.kt
  src/commonTest/kotlin/borg/trikeshed/userspace/MemoryMappingConformance.kt
  src/jvmTest/kotlin/borg/trikeshed/userspace/MemoryMappingTest.kt
...
java --enable-native-access=ALL-UNNAMED -Dkotlinx.coroutines.test.default_timeout=10s -cp "$TRIKESHED_VERIFY_OUT/uring-tests.jar:$TRIKESHED_TEST_CP" org.junit.runner.JUnitCore \
  borg.trikeshed.userspace.EmulatedRingTest \
  borg.trikeshed.userspace.MemoryMappingTest \
