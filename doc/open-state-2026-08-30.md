...
**1. M4 durability gate is BLOCKED, not failed.** Evidence is strong (12 impulses restore, 12 rules
...
**2. `--once` cannot exit — the full suite is unrunnable.** `OroborosDaemon.main` (line ~240) wraps
