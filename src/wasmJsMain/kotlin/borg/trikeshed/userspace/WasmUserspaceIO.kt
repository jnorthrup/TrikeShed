...
private class WasmUserspaceRing : UserspaceRing {
...
private object WasmUserspaceSPI : UserspaceSPI {
    private var nextFd = 1

    override fun createRing(entries: Int): UserspaceRing = WasmUserspaceRing()
...
actual val userspaceSPI: UserspaceSPI = WasmUserspaceSPI
