...
/**
 * A [borg.trikeshed.common.collections.SortedSet] extended with navigation methods reporting
...
interface NavigableSet<E:Comparable<E>> : borg.trikeshed.common.collections.SortedSet<E> {
    /**
     ...
     */
    fun descendingSet(): borg.trikeshed.common.collections.NavigableSet<E>
     ...
     * bounds of the range
     */
    fun headSet(toElement: E, inclusive: Boolean): borg.trikeshed.common.collections.NavigableSet<E>
     ...
     * bounds of the range
     */
    fun tailSet(fromElement: E, inclusive: Boolean): borg.trikeshed.common.collections.NavigableSet<E>
