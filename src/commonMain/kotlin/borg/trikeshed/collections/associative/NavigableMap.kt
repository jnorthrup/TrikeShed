...
/**
 * A [borg.trikeshed.common.collections.associative.SortedMap] extended with navigation methods returning the
 ...
 * [.keySet] can be overridden to return [borg.trikeshed.common.collections.NavigableSet].
 *
 *
...
interface NavigableMap<K : Comparable<K>, V> : borg.trikeshed.common.collections.associative.SortedMap<K, V> {
    /**
     ...
     */
    fun descendingMap(): borg.trikeshed.common.collections.associative.NavigableMap<K, V>?

    /**
     * Returns a [borg.trikeshed.common.collections.NavigableSet] view of the keys contained in this map.
     ...
     */
    fun navigableKeySet(): borg.trikeshed.common.collections.NavigableSet<K>?

    /**
     * Returns a reverse order [borg.trikeshed.common.collections.NavigableSet] view of the keys contained in this map.
     ...
     */
    fun descendingKeySet(): borg.trikeshed.common.collections.NavigableSet<K>?
    ...
    ): borg.trikeshed.common.collections.associative.NavigableMap<K, V>?
     ...
     * bounds of the range
     */
    fun headMap(toKey: K, inclusive: Boolean): borg.trikeshed.common.collections.associative.NavigableMap<K, V>?
     ...
     * bounds of the range
     */
    fun tailMap(fromKey: K, inclusive: Boolean): borg.trikeshed.common.collections.associative.NavigableMap<K, V>?
     ...
     */
    override fun subMap(fromKey: K, toKey: K): borg.trikeshed.common.collections.associative.SortedMap<K, V>?
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    override fun headMap(toKey: K): borg.trikeshed.common.collections.associative.SortedMap<K, V>?
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    override fun tailMap(fromKey: K): borg.trikeshed.common.collections.associative.SortedMap<K, V>?
