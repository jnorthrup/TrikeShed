...
interface SortedMap<K, V> : MutableMap<K, V> {
     ...
     */
    fun subMap(fromKey: K, toKey: K): borg.trikeshed.common.collections.associative.SortedMap<K, V>?
     ...
     * bounds of the range
     */
    fun headMap(toKey: K): borg.trikeshed.common.collections.associative.SortedMap<K, V>?
     ...
     * bounds of the range
     */
    fun tailMap(fromKey: K): borg.trikeshed.common.collections.associative.SortedMap<K, V>?
