...
enum class UringOp(val desc: String) : BitMasked<Long> {
    ...
    FLISTXATTR("flistxattr — list extended attrs by fd"),
    LISTXATTR("listxattr — list extended attrs by path"),
    FREMOVEXATTR("fremovexattr — remove extended attr by fd"),
    REMOVEXATTR("removexattr — remove extended attr by path"),
