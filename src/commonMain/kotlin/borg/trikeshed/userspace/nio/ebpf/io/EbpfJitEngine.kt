...
import borg.trikeshed.userspace.nio.ebpf.engine.X86_64Jit
import borg.trikeshed.userspace.nio.ebpf.verifier.VerifierResult
import borg.trikeshed.userspace.nio.ebpf.verifier.verifyProgram
import borg.trikeshed.userspace.nio.ebpf.runNative
...
class EbpfJitEngine(
    ...
    fun verify(): VerifierResult {
        val program = EbpfProgram(name, LongArray(instructions.size) { instructions[it] }, programType, license)
