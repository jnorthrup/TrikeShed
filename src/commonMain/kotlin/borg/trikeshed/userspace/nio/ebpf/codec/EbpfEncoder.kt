package borg.trikeshed.userspace.nio.ebpf.codec
...
object EbpfEncoder {
    fun encode(program: EbpfProgram): ByteArray {
        ...
        val buf = borg.trikeshed.userspace.nio.ByteBuffer.wrap(result)
        buf.order(borg.trikeshed.userspace.nio.ByteOrder.LITTLE_ENDIAN)
