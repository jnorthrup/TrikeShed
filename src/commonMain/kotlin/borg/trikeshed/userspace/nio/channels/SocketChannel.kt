...
public abstract class SocketChannel : AbstractSelectableChannel, ByteChannel, ScatteringByteChannel, GatheringByteChannel, NetworkChannel {
    ...
    public abstract override fun bind(address: CharSequence): SocketChannel
    public abstract override fun <T> setOption(option: CharSequence, value: T): SocketChannel
    // TODO
    ...
    // TODO
    abstract fun connect(address: CharSequence): Boolean
    ...
    companion object {
        ...
        fun openWithProtocolFamily(protocolFamily: CharSequence): SocketChannel = open()
        fun openWithRemote(address: CharSequence): SocketChannel { val ch = open(); ch.connect(address); return ch }
    }
}
...
internal class UringSocketChannel(
    ...
    override fun bind(address: CharSequence): SocketChannel = this
    override fun <T> setOption(option: CharSequence, value: T): SocketChannel = this
    ...
    // TODO
    override fun connect(address: CharSequence): Boolean = TODO("connect")
