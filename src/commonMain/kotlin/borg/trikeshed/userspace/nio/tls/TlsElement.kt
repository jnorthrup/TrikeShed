 ...
 */
expect fun createTlsEngine(settings: borg.trikeshed.userspace.nio.tls.TlsSettings): borg.trikeshed.userspace.nio.tls.TlsEngine
...
class TlsElement(
    ...
    private var engine: borg.trikeshed.userspace.nio.tls.TlsEngine? = null
