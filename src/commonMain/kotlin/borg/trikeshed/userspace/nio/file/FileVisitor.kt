...
public interface FileVisitor<T> {
    ...
    fun visitFileFailed(p0: T, p1: borg.trikeshed.userspace.nio.IOException): borg.trikeshed.userspace.nio.file.FileVisitResult
    fun postVisitDirectory(p0: T, p1: borg.trikeshed.userspace.nio.IOException): borg.trikeshed.userspace.nio.file.FileVisitResult
}
