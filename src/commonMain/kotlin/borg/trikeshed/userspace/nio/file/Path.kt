...
public interface Path : Comparable<Path>, Iterable<Path>, Watchable {
    ...
    fun startsWith(p0: CharSequence): Boolean // TODO("NIO common stub")
    fun endsWith(p0: Path): Boolean // TODO("NIO common stub")
    fun endsWith(p0: CharSequence): Boolean // TODO("NIO common stub")
    fun normalize(): Path // TODO("NIO common stub")
    fun resolve(p0: Path): Path // TODO("NIO common stub")
    fun resolve(p0: CharSequence): Path // TODO("NIO common stub")
    fun resolve(p0: Path, vararg p1: Path): Path // TODO("NIO common stub")
    fun resolve(p0: CharSequence, vararg p1: CharSequence): Path // TODO("NIO common stub")
    fun resolveSibling(p0: Path): Path // TODO("NIO common stub")
    fun resolveSibling(p0: CharSequence): Path // TODO("NIO common stub")
    fun relativize(p0: Path): Path // TODO("NIO common stub")
    fun toUri(): CharSequence // TODO("NIO common stub")
    ...
    override fun register(
        p0: WatchService,
        p1: Array<WatchEvent.Kind<*>>,
        vararg p2: WatchEvent.Modifier
    ): WatchKey // TODO("NIO common stub")
    ...
    companion object {
        fun of(p0: CharSequence, vararg p1: CharSequence): Path = TODO("NIO common stub")
        fun of(p0: CharSequence): Path = TODO("NIO common stub")
    }
}
