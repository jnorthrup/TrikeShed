...
public abstract class FileSystem {
    ...
    fun getSeparator(): CharSequence = TODO("NIO common stub")
    ...
    fun supportedFileAttributeViews(): Set<CharSequence> = TODO("NIO common stub")
    fun getPath(p0: CharSequence, vararg p1: CharSequence): borg.trikeshed.userspace.nio.file.Path = TODO("NIO common stub")
    fun getPathMatcher(p0: CharSequence): borg.trikeshed.userspace.nio.file.PathMatcher = TODO("NIO common stub")
