...
object CcekNodes {
    ...
    private suspend fun validateCcekScope(): ScopeValidation {
        ...
        val job = context[LcncOwnerJob]?.job ?: context[Job]
            ?: throw IllegalStateException("CCEK scope requires a CompletableJob")
        if (job !is CompletableJob && job::class.simpleName != "UndispatchedCoroutine") {
