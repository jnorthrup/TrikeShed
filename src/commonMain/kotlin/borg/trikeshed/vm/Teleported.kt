...
sealed class Teleported {
    ...
    companion object {
        ...
        fun ofHost(o: Any?): Teleported = when (o) {
            ...
            is Map<*, *> -> Obj(o.entries.map { it.key.toString() to ofHost(it.value) }.sortedBy { it.first }.toMap()) // ⚡ Bolt: Prevent intermediate List allocations by using map directly instead of associate.toList()
