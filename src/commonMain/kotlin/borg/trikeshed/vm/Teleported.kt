...
sealed class Teleported {
    ...
    companion object {
        ...
        fun ofHost(o: Any?): Teleported = when (o) {
            ...
            is Map<*, *> -> Obj(o.entries.map { it.key.toString() to ofHost(it.value) }.sortedBy { it.first }.toMap()) // ⚡ Bolt: Use map instead of associate.toList() to avoid intermediate Map and List allocations
