...
suspend fun drainSynth6046650816859623792(store: JulesBoardStore) {
    store.appendWork("rework:synth:6046650816859623792#1", JulesCause.WorkDrained(
        workId = "rework:synth:6046650816859623792#1",
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
        taskId = "supersede-pass",
        receipt = MergeReceipt(
            ...
            lexicalMemory = LexicalMemory(
                ...
                title = "[rework #1] TDD PR Deliver TASK G12 MED Cycles published as KanbanEvent.CycleObserved",
