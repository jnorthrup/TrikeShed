...
suspend fun drainSession910891952515077349(store: JulesBoardStore) {
    val workId = "session:910891952515077349"
...
suspend fun drainSession8931659086090151049(store: JulesBoardStore) {
    val workId = "session:8931659086090151049"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId,
        "necromanced",
