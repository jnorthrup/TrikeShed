...
suspend fun drainSession14162871126292114727(store: JulesBoardStore) {
    val workId = "session:14162871126292114727"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
...
suspend fun drainSession15466567759278489251(store: JulesBoardStore) {
    val workId = "session:15466567759278489251"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
...
=======
    drainSession15412781732592297384(store)
>>>>>>> theirs
=======
suspend fun drainSession17124310003071247396(store: JulesBoardStore) {
    val workId = "session:17124310003071247396"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
        ...
        receipt = MergeReceipt(
            ...
            lexicalMemory = LexicalMemory(
                "Superseded necromanced work",
                "Cache static Regex instances in TypeDefOracle",
                "Superseded via drain script."
            ),
            claimedAt = 0L
        ),
...
>>>>>>> theirs
=======
suspend fun drainSession17389565571177971407(store: JulesBoardStore) {
    val workId = "session:17389565571177971407"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
        ...
        receipt = MergeReceipt(
            ...
            lexicalMemory = LexicalMemory(
                "Superseded necromanced work",
                "[rework #1] Browser mutations lower to JobCommand",
                "Superseded via drain script."
            ),
            claimedAt = 0L
        ),
...
suspend fun drainWork(store: JulesBoardStore) {
    drainSession17389565571177971407(store)
>>>>>>> theirs
    ...
    drainSession14439075584174324583(store)
...
>>>>>>> theirs
=======
    drainSession15568794059648627721(store)
>>>>>>> theirs
=======
    drainSession15332030174260280373(store)
>>>>>>> theirs
}
...
>>>>>>> theirs
    store.appendWork(workId, JulesCause.WorkDrained(
        ...
        receipt = MergeReceipt(
            ...
            lexicalMemory = LexicalMemory(
                "Superseded necromanced work",
                "Jules VM Probing and liburing Facade Analysis",
                "Superseded via drain script."
            ),
            claimedAt = 0L
        ),
...
suspend fun drainSession13065137133469730772(store: JulesBoardStore) {
    val workId = "session:13065137133469730772"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
...
suspend fun drainSession14155293206313409695(store: JulesBoardStore) {
    val workId = "session:14155293206313409695"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
...
suspend fun drainSession15412781732592297384(store: JulesBoardStore) {
    val workId = "session:15412781732592297384"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
        ...
        receipt = MergeReceipt(
            ...
            lexicalMemory = LexicalMemory(
                "Superseded necromanced work",
                "Fix BTRFS Device Tree Data Offset Logic",
                "Superseded via drain script."
            ),
            claimedAt = 0L
        ),
...
suspend fun drainSession15568794059648627721(store: JulesBoardStore) {
    val workId = "session:15568794059648627721"
    store.appendWork(workId, JulesCause.WorkDrained(
        workId = workId,
        sessionId = "necromanced",
        commitSha = "superseded-by-review",
        ...
        receipt = MergeReceipt(
            ...
            lexicalMemory = LexicalMemory(
                "Superseded necromanced work",
                "Reject stale Couch head commits",
                "Superseded via drain script."
            ),
            claimedAt = 0L
        ),
