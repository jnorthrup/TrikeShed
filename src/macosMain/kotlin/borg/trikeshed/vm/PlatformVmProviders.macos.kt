...
/**
 * macos: no VM tier is provided yet — process tier needs an interactive ProcessPipe (ProcessWorker is run-to-completion) — next ratchet. The supervisor binds [VmHost.NONE]
