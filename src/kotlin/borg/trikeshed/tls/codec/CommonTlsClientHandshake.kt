...
class CommonTlsClientHandshake(
    ...
    private fun buildExtensions(): ByteArray = ByteArrayBuilder().run {
        putExtension(43) { put8(2); put16(0x0304) } // supported_versions: TLS 1.3
        putExtension(10) { put16(2); put16(0x001D) } // supported_groups: X25519
        putExtension(51) { put16(clientKeyPair.publicKey.size + 4); put16(0x001D); putVar16(clientKeyPair.publicKey) } // key_share
        putExtension(13) { put16(4); put16(0x0403); put16(0x0401) } // sig_algs: ecdsa_secp256r1_sha256, rsa_pkcs1_sha256
        putExtension(0) { // SNI
